...
export default function App() {
    ...
    useEffect(() => {
        ...
        socket.current.on("connect", () => {
            ...
            socket.current.on("RoomNotice", (user) => {
        ...
        return () => {
            ...
            socket.current.off("chatMessages")
                        ...
                        <div className="flex items-center justify-between gap-4 border border-gray-200 rounded-full">
                            ...
                            <button
                                ...
                                className={`px-4 py-2 mr-2 rounded-full text-sm font-medium 
                                 ${text ? "bg-green-500 text-white cursor-pointer" : "bg-gray-300 text-gray-500 cursor-not-allowed"}
                                `}
                            >
                                Send
                            </button>
